              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        final Map<String, ServiceCategoryModel> catMap = {};
                        final List<ServiceCategoryModel> availableCats = _categories.isNotEmpty
                            ? _categories
                            : [
                                ServiceCategoryModel(id: 'general', name: 'General Advice'),
                                ServiceCategoryModel(id: 'plumbing', name: 'Plumbing'),
                                ServiceCategoryModel(id: 'electrical', name: 'Electrical'),
                                ServiceCategoryModel(id: 'carpentry', name: 'Carpentry'),
                                ServiceCategoryModel(id: 'masonry', name: 'Masonry'),
                                ServiceCategoryModel(id: 'painting', name: 'Painting'),
                                ServiceCategoryModel(id: 'ac-repair', name: 'AC Repair'),
                                ServiceCategoryModel(id: 'roofing', name: 'Roofing'),
                                ServiceCategoryModel(id: 'appliance-repair', name: 'Appliance Repair'),
                                ServiceCategoryModel(id: 'cctv-security', name: 'CCTV & Security'),
                              ];

                        for (var c in availableCats) {
                          if (c.id.isNotEmpty && !catMap.containsKey(c.id.toLowerCase())) {
                            catMap[c.id.toLowerCase()] = c;
                          }
                        }
                        if (!catMap.containsKey('general')) {
                          catMap['general'] = ServiceCategoryModel(id: 'general', name: 'General Advice');
                        }

                        final categoryList = catMap.values.toList();
                        final String matchedCatId = categoryList.any((c) => c.id.toLowerCase() == selectedCatId.toLowerCase())
                            ? categoryList.firstWhere((c) => c.id.toLowerCase() == selectedCatId.toLowerCase()).id
                        ...
                        return DropdownButtonFormField<String>(
                          ...
                          items: categoryList.map((c) => DropdownMenuItem<String>(
                            value: c.id,
                            child: Text(c.name),
                          )).toList(),
                          onChanged: (val) {
        ...
        builder: (context, setDialogState) {
          return AlertDialog(
            ...
            content: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Select reason for reporting this post to moderators:'),
